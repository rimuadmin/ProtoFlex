...
- [Command Index](#command-index)
  - [SLICE CREATE](#slice-create)
  - [SLICE CREATE (Clone)](#slice-create-clone)
  - [SLICE LOCK](#slice-lock)
  - [SLICE M](#slice-m)
  - [SLICE REMOVE](#slice-remove)
  - [SLICE SET](#slice-set)
  - [SLICE TUNE](#slice-tune)
  - [SLICE AUTO\_TUNE](#slice-auto_tune)
  - [SLICE WAVEFORM\_CMD](#slice-waveform_cmd)
