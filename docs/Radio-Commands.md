...
- [Command Index](#command-index)
  - [RADIO BACKLIGHT](#radio-backlight)
  - [RADIO CALLSIGN](#radio-callsign)
  - [RADIO FILTER\_SHARPNESS](#radio-filter_sharpness)
  - [RADIO GPS](#radio-gps)
    - [INSTALL](#install)
    - [UNINSTALL](#uninstall)
  - [LED\_DISPLAY SET](#led_display-set)
  - [RADIO NAME](#radio-name)
  - [RADIO OSCILLATOR](#radio-oscillator)
  - [RADIO PLL\_START](#radio-pll_start)
  - [RADIO REBOOT](#radio-reboot)
  - [RADIO SCREENSAVER](#radio-screensaver)
  - [RADIO SET](#radio-set)
  - [RADIO STATIC\_NET\_PARAMS](#radio-static_net_params)
    - [SET STATIC PARAMETERS](#set-static-parameters)
...
| Hex Code | Meaning |
|----------|----------|
| 00000000 | OK radio callsign set |
