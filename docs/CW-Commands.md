...
**Notes:**
- CW key and PTT commands require a NetCW stream for proper operation (created via `stream create netcw`)
- Commands are sent multiple times with delays (immediately, +5ms, +10ms, +15ms) for reliability
